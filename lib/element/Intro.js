System.register(["pixi.js", "../ui/Panel", "./btn/BtnPlay"], function (exports_1, context_1) {
    "use strict";
    ...
    var pixi_js_1, Panel_1, BtnPlay_1, Intro;
    return {
        setters: [
        ...
        execute: function () {
            ...
            Intro = (function (_super) {
                ...
                function Intro() {
                    ...
                    _this.playButton.on('tap', function () {
                        _this.playButton.text = 'BLA';
                        _this.playButton.resize(Math.random() * 500, Math.random() * 500);
