System.register(["./WordWrapper"], function (exports_1, context_1) {
    ...
    var WordWrapper_1, DEFAULT_LINE_HEIGHT, DEFAULT_PX_SIZE, Align, ComputeLayout;
    return {
        setters: [
        ...
        execute: function () {
            ...
            ComputeLayout = (function () {
                function ComputeLayout(text, font, fontSize) {
                    this._text = text;
                    this._font = font;
                ...
                ComputeLayout.prototype.getPosByData = function (data) {
                    var x = this.getPxByUnit(glyph.position.x);
                };
