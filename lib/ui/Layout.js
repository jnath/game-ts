System.register(['pixi.js'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ...
            exports_1("Dock", Dock);
            pixi_js_1.Container.prototype['_dock'] = Dock.NONE;
            Object.defineProperty(pixi_js_1.Container.prototype, 'dock', {
                get: function () { return this._dock; },
                set: function (value) {
                    this._dock = value;
                },
                enumerable: true,
            ...
            Layout = (function (_super) {
                ...
                Layout.prototype.childDock = function (child) {
                    ...
                    if ((child.dock & Dock.BOTTOM) === Dock.BOTTOM) {
                        ...
                        child.y = this._height - (child.height || 0);
                    }
