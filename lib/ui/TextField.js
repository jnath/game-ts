        ...
        execute: function() {
            TextField = (function (_super) {
                ...
                function TextField(text, styles, rendererOptions, canvas) {
                    ...
                    Object.keys(this._styles).forEach(function (tagName) {
                ...
                TextField.prototype.updateText = function () {
                    ...
                    metrics.glyphs.forEach(function (glyph) {
                        glyph.data.draw(_this._context, _this.computeLayer.getPxByUnit(glyph.position.x, glyph.style), _this.computeLayer.getPxByUnit(glyph.position.y, _this._styles.default), glyph.style.fontSize);
                    });
                };
