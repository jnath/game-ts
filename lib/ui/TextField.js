        ...
        execute: function () {
            TextField = (function (_super) {
                ...
                function TextField(text, style, rendererOptions, canvas) {
                    ...
                    _this._style = style;
                    _this._style.fontSize = style.fontSize || 12;
                    _this._font = AssetLoader_1.default.getFont(_this._style.fontName);
                    _this.computeLayer = new ComputeLayout_1.default(_this._text, _this._font, _this._style.fontSize);
                    _this.updateText();
                    return _this;
                }
                ...
                TextField.prototype.updateText = function () {
                    var _this = this;
                    var fontSizePx = this.computeLayer.getFontSizePx(this._font, this._style.fontSize);
                    ...
                    metrics.glyphs.forEach(function (glyph) {
                        glyph.data.draw(_this._context, _this.computeLayer.getPxByUnit(glyph.position.x), _this.computeLayer.getPxByUnit(glyph.position.y), _this._style.fontSize);
                    });
                };
