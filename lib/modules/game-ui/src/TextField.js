System.register(["pixi.js", "./FontLoader", "./tools/ComputeLayout", "./tools/TagMapper"], function (exports_1, context_1) {
    "use strict";
    ...
    function isStyles(object) {
        return 'default' in object;
    }
    var pixi_js_1, FontLoader_1, ComputeLayout_1, TagMapper_1, TextField;
    return {
        setters: [
        ...
        execute: function () {
            ...
            exports_1("Styles", TagMapper_1.Styles);
            exports_1("Style", TagMapper_1.Style);
            TextField = (function (_super) {
                ...
                function TextField(text, styles, options, canvas) {
                    ...
                    _this.computeLayer = new ComputeLayout_1.default(_this._text, _this.parseStyle(tmpStyles));
