        ...
        execute: function () {
            ...
            Layout = (function (_super) {
                ...
                function Layout() {
                    ...
                    _this._scaleY = 1;
                    _this._scaleXY = 1;
                    _this.on('updatePosition', function () { return _this.childPositioning(); });
                    _this.onChildrenChange = function () { return _this.childPositioning(); };
                    return _this;
                }
                ...
                Layout.prototype.childPositioning = function () {
                    var _this = this;
                    this.emit('resize');
                    this.children.forEach(function (child) { return _this.childDock(child); });
