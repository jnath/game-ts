System.register(["pixi.js", "./process/AssetLoader", "./ui/Layout", "./ui/ProgressBar", "./ui/Padding", "./element/Intro", "./process/Position", "./GamePlay", "gsap"], function (exports_1, context_1) {
    ...
    var pixi_js_1, AssetLoader_1, Layout_1, ProgressBar_1, Padding_1, Intro_1, Position_1, GamePlay_1, gsap_1, Game;
    return {
        setters: [
            ...
            Game = (function (_super) {
                ...
                function Game() {
                    ...
                    _this.load('all', function () {
                        ...
                        var panel = new Intro_1.default();
                        panel.dock = Layout_1.Dock.CENTER | Layout_1.Dock.MIDDLE;
                        panel.width = _this.width / 3 * 2;
                        panel.height = _this.height / 3 * 2;
                        _this.addChild(panel);
                        _this.on('resize', function () {
                            gsap_1.default.to(panel, 1, { width: _this.width / 3 * 2, height: _this.height / 3 * 2, ease: Elastic.easeOut.config(1, 0.3) });
                        });
                    });
