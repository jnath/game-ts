System.register(['pixi.js', './process/AssetLoader', './ui/Layout', './ui/ProgressBar', './ui/Padding', 'gsap'], function(exports_1, context_1) {
    "use strict";
    ...
    var pixi_js_1, AssetLoader_1, Layout_1, ProgressBar_1, Padding_1, gsap_1;
    var Game;
    return {
        setters:[
            ...
            Game = (function (_super) {
                ...
                Game.prototype.load = function (cathName, cb) {
                    ...
                    loader.onComplete.once(function () {
                        ...
                        gsap_1.default.to(_this.progress.scale, .5, {
                            x: 0,
                            y: 0,
                            onComplete: function () {
