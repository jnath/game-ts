System.register(["pixi.js", "dat-gui", "./process/AssetLoader", "./ui/Layout", "./ui/ProgressBar", "./ui/Padding", "./element/Intro", "./process/Position", "./GamePlay", "./StateManager", "./ui/TextField", "gsap"], function (exports_1, context_1) {
    "use strict";
    ...
    var pixi_js_1, dat_gui_1, AssetLoader_1, Layout_1, ProgressBar_1, Padding_1, Intro_1, Position_1, GamePlay_1, StateManager_1, TextField_1, gsap_1, Game;
    return {
        setters: [
                    ...
                    _this.load('all', function () {
                        ...
                        StateManager_1.default.getInstance().start(function () {
                            ...
                            gui.add(proxyAlign, 'align', {
                                'left': TextField_1.Align.LEFT,
                                'center': TextField_1.Align.CENTER,
                                'right': TextField_1.Align.RIGHT
                            });
